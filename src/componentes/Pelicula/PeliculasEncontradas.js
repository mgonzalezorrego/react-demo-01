...
const PeliculasEncontradas = (props) => (
    ...
    <div>
        ...
        <Media key={pelicula.trackId}>
            ...
            <Media.Body>
                <Media.Heading>{
                    pelicula.trackName} <small>{pelicula.primaryGenreName}</small> <Label>{pelicula.contentAdvisoryRating}</Label>
                </Media.Heading>
                <p>{pelicula.longDescription}</p>
                <Button bsSize="xsmall" href={pelicula.previewUrl}>Ver</Button>
            </Media.Body>
        </Media>
